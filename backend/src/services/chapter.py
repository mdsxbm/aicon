...
class ChapterService(BaseService):
    ...
    # Removed: transition_to_materials_prepared - obsolete method using deleted MovieProductionService
    # TODO: Implement new version using TransitionService if needed
